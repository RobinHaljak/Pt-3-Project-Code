...
csv_file = r"C:\Users\halja\Desktop\MyProjectCode\pt-3-project\PLOT_DICEvVOL.csv"

x_s = []
y_s = []

title = r'$\mathbf{Dice}~\mathrm{vs.}~\mathbf{VTT}~\mathbf{Volume}~\textit{(mm}^\mathbf{3}\textit{)}~\text{for 2-stage model.}$'
...
ax.legend(legend,fontsize=legend_fsize,loc='lower right')
